...
$settings['hash_salt'] = 'W98BvW55QxsuNePqrVb_C7xGzoDNV-F_49q1d9T69IZAqqwxZOkCjEVvVSNH10YNuYNJTSLGZg';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT']) && ($_SERVER['HTTP_HOST'] == 'finearts.limestone.edu') && (php_sapi_name() != "cli")) {
  $newurl = 'https://www.limestone.edu/fine-arts'. $_SERVER['REQUEST_URI'];
  header('HTTP/1.0 301 Moved Permanently');
  header("Location: $newurl");
...
if (isset($_ENV['PANTHEON_ENVIRONMENT']) && ($_SERVER['HTTP_HOST'] == 'think.limestone.edu') && (php_sapi_name() != "cli")) {
  $newurl = 'https://www.limestone.edu/think'. $_SERVER['REQUEST_URI'];
  header('HTTP/1.0 301 Moved Permanently');
  header("Location: $newurl");
