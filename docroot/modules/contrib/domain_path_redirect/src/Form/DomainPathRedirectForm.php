...
class DomainPathRedirectForm extends ContentEntityForm {
    ...
    if ($redirect->isNew()) {
      ...
      if (!empty($redirect_url)) {
        try {
          ...
          $this->messenger()->addWarning($this->t('Invalid redirect URL %url provided.', ['%url' => $redirect_url]));
        }
      }
  ...
  public function save(array $form, FormStateInterface $form_state) {
    $this->entity->save();
    $this->messenger()->addStatus($this->t('The redirect has been saved.'));
