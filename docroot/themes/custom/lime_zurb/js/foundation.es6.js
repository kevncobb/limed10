  ...
  _createClass(Abide, [{
    ...
    value: function validateForm() {
      ...
      this.$element.find('[data-abide-error]').each(function (i, elem) {
        ...
        if (_this10.options.a11yAttributes) _this10.addGlobalErrorA11yAttributes($elem);
    ...
    value: function validateCheckbox(groupName) {
      ...
      $group.each(function (i, e) {
        if (!valid) {
          _this11.addErrorClasses(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e), ['required']);
        } else {
          _this11.removeErrorClasses(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e));
        }
      });
      return valid;
    }
    ...
    value: function matchValidation($el, validators, required) {
      ...
      var clear = validators.split(' ').map(function (v) {
        return _this12.options.validators[v]($el, required, $el.parent());
      });
  ...
  _createClass(Accordion, [{
    ...
    value: function _init() {
      ...
      this._checkDeepLink = function () {
        ...
        if (!anchor.length) {
          ...
          if (_this13._isInitializing) return;
          // Otherwise, move to the initial anchor
          if (_this13._initialAnchor) anchor = _this13._initialAnchor;
        }
        var $anchor = anchor && jquery__WEBPACK_IMPORTED_MODULE_0___default()(anchor);
        var $link = anchor && _this13.$element.find("[href$=\"".concat(anchor, "\"]"));
        ...
        if (isOwnAnchor) {
          ...
          if ($anchor && $link && $link.length) {
            if (!$link.parent('[data-accordion-item]').hasClass('is-active')) {
              _this13._openSingleTab($anchor);
            }
          }
          // Otherwise, close everything
          else {
            _this13._closeAllTabs();
          }

          // Roll up a little to show the titles
          if (_this13.options.deepLinkSmudge) {
            onLoad(jquery__WEBPACK_IMPORTED_MODULE_0___default()(window), function () {
              var offset = _this13.$element.offset();
              jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').animate({
                scrollTop: offset.top - _this13.options.deepLinkSmudgeOffset
              }, _this13.options.deepLinkSmudgeDelay);
            });
          }
           ...
           */
          _this13.$element.trigger('deeplink.zf.accordion', [$link, $anchor]);
        }
      };
    ...
    value: function _openTab($target) {
      ...
      $target.finish().slideDown(this.options.slideSpeed, function () {
         ...
         */
        _this14.$element.trigger('down.zf.accordion', [$target]);
      });
    }
    ...
    value: function _closeTab($target) {
      ...
      $target.finish().slideUp(this.options.slideSpeed, function () {
         ...
         * @event Accordion#up
         */
        _this15.$element.trigger('up.zf.accordion', [$target]);
      });
    }
...
var AccordionMenu = /*#__PURE__*/function (_Plugin3) {
  ...
  var _super3 = _createSuper(AccordionMenu);
  ...
  _createClass(AccordionMenu, [{
    ...
    value: function down($target) {
      ...
      $target.slideDown(this.options.slideSpeed, function () {
         ...
         */
        _this16.$element.trigger('down.zf.accordionMenu', [$target]);
      });
    }
    ...
    value: function up($target) {
      ...
      $target.slideUp(this.options.slideSpeed, function () {
         ...
         */
        _this17.$element.trigger('up.zf.accordionMenu', [$target]);
      });
    }
...
var Drilldown = /*#__PURE__*/function (_Plugin4) {
  ...
  var _super4 = _createSuper(Drilldown);
  function Drilldown() {
  ...
  _createClass(Drilldown, [{
    ...
    value: function _hideAll() {
      ...
      $elem.one(transitionend($elem), function () {
         ...
         */
        _this18.$element.trigger('closed.zf.drilldown');
      });
    }
...
var Positionable = /*#__PURE__*/function (_Plugin5) {
  ...
  var _super5 = _createSuper(Positionable);
...
var Dropdown = /*#__PURE__*/function (_Positionable) {
  ...
  var _super6 = _createSuper(Dropdown);
  function Dropdown() {
  ...
  _createClass(DropdownMenu, [{
    ...
    value: function _addBodyHandler() {
      ...
      $body.on('click.zf.dropdownMenu tap.zf.dropdownMenu', function (e) {
        var isItself = !!jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest(_this19.$element).length;
        if (isItself) return;
        _this19._hide();
        _this19._removeBodyHandler();
      });
    }
...
var Equalizer = /*#__PURE__*/function (_Plugin7) {
  ...
  var _super8 = _createSuper(Equalizer);
  function Equalizer() {
...
var Interchange = /*#__PURE__*/function (_Plugin8) {
  ...
  var _super9 = _createSuper(Interchange);
    ...
    value: function replace(path) {
      ...
      // Replacing HTML
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default().get(path, function (response) {
          _this21.$element.html(response).trigger(trigger);
...
var SmoothScroll = /*#__PURE__*/function (_Plugin9) {
  ...
  var _super10 = _createSuper(SmoothScroll);
 ...
 * @requires foundation.util.triggers
 */
var Magellan = /*#__PURE__*/function (_Plugin10) {
  _inherits(Magellan, _Plugin10);
  var _super11 = _createSuper(Magellan);
  function Magellan() {
    ...
    value: function _updateActive( /*evt, elem, scrollPos*/
      ...
      // Otherwhise, use the last visible link
        ...
        var visibleLinks = this.points.filter(function (p) {
          return p - _this23.options.offset - (isScrollingUp ? _this23.options.threshold : 0) <= newScrollPos;
        });
 ...
 * @requires foundation.util.triggers
 */
var OffCanvas = /*#__PURE__*/function (_Plugin11) {
  _inherits(OffCanvas, _Plugin11);
  var _super12 = _createSuper(OffCanvas);
  function OffCanvas() {
  ...
  _createClass(OffCanvas, [{
    ...
    function _setup(element, options) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(['push', 'overlap']).each(function (index, val) {
        _this24.contentClasses.base.push('has-transition-' + val);
      });
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(['left', 'right', 'top', 'bottom']).each(function (index, val) {
        _this24.contentClasses.base.push('has-position-' + val);
        _this24.contentClasses.reveal.push('has-reveal-' + val);
      });
    ...
    value: function open(event, trigger) {
       ...
       */
      this.$element.one(transitionend(this.$element), function () {
        _this26.$element.trigger('openedEnd.zf.offCanvas');
      });
    }
    ...
    value: function close() {
      ...
      this.$element.one(transitionend(this.$element), function () {
        _this27.$element.addClass('is-closed');
        _this27._removeContentClasses();
        if (_this27.options.transition === 'push') {
          _this27._unfixStickyElements();
        }

        // If `contentScroll` is set to false, remove class and re-enable scrolling on touch devices.
        if (_this27.options.contentScroll === false) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass('is-off-canvas-open').off('touchmove', _this27._stopScrolling);
          _this27.$element.off('touchstart', _this27._recordScrollable);
          _this27.$element.off('touchmove', _this27._preventDefaultAtEdges);
          _this27.$element.off('touchstart', '[data-off-canvas-scrollbox]', _this27._recordScrollable);
          _this27.$element.off('touchmove', '[data-off-canvas-scrollbox]', _this27._scrollboxTouchMoved);
        }
        if (_this27.options.trapFocus === true) {
          _this27.$content.removeAttr('tabindex');
          Keyboard.releaseFocus(_this27.$element);
        }
         ...
         */
        _this27.$element.trigger('closed.zf.offCanvas');
      });
    }
 ...
 * @requires foundation.util.touch
 */
var Orbit = /*#__PURE__*/function (_Plugin12) {
  _inherits(Orbit, _Plugin12);
  var _super13 = _createSuper(Orbit);
  function Orbit() {
 ...
 * @requires foundation.util.mediaQuery
 */
var ResponsiveMenu = /*#__PURE__*/function (_Plugin13) {
  _inherits(ResponsiveMenu, _Plugin13);
  var _super14 = _createSuper(ResponsiveMenu);
 ...
 * @requires foundation.util.motion
 */
var ResponsiveToggle = /*#__PURE__*/function (_Plugin14) {
  _inherits(ResponsiveToggle, _Plugin14);
  var _super15 = _createSuper(ResponsiveToggle);
        ...
        if (this.options.animate) {
          if (this.$targetMenu.is(':hidden')) {
            Motion.animateIn(this.$targetMenu, this.animationIn, function () {
              _this29.$element.trigger('toggled.zf.responsiveToggle');
              _this29.$targetMenu.find('[data-mutate]').triggerHandler('mutateme.zf.trigger');
            });
          } else {
 ...
 */
var Reveal = /*#__PURE__*/function (_Plugin15) {
  _inherits(Reveal, _Plugin15);
  var _super16 = _createSuper(Reveal);
  function Reveal() {
      ...
      this.$element.on({
        ...
        'close.zf.trigger': function closeZfTrigger(event, $element) {
          if (event.target === _this.$element[0] || jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).parents('[data-closable]')[0] === $element) {
            ...
            return _this31.close.apply(_this31);
          }
        },
        'toggle.zf.trigger': this.toggle.bind(this),
      ...
      if (this.options.animationIn) {
        ...
        Motion.animateIn(this.$element, this.options.animationIn, function () {
          if (_this32.$element) {
            ...
            _this32.focusableElements = Keyboard.findFocusable(_this32.$element);
            afterAnimation();
          }
        });
      }
 ...
 * @requires foundation.util.touch
 */
var Slider = /*#__PURE__*/function (_Plugin16) {
  _inherits(Slider, _Plugin16);
  var _super17 = _createSuper(Slider);
  function Slider() {
    ...
    value: function setHandles() {
      ...
      if (this.handles[1]) {
        this._setHandlePos(this.$handle, this.inputs.eq(0).val(), function () {
          _this33._setHandlePos(_this33.$handle2, _this33.inputs.eq(1).val());
        });
      } else {
 ...
 * @requires foundation.util.mediaQuery
 */
var Sticky = /*#__PURE__*/function (_Plugin17) {
  _inherits(Sticky, _Plugin17);
  var _super18 = _createSuper(Sticky);
  function Sticky() {
 ...
 */
var Tabs = /*#__PURE__*/function (_Plugin18) {
  _inherits(Tabs, _Plugin18);
  var _super19 = _createSuper(Tabs);
  function Tabs() {
  ...
  _createClass(Tabs, [{
    ...
    value: function _init() {
      ...
      this._checkDeepLink = function () {
        ...
        if (!anchor.length) {
          // If we are still initializing and there is no anchor, then there is nothing to do
          if (_this34._isInitializing) return;
          // Otherwise, move to the initial anchor
          if (_this34._initialAnchor) anchor = _this34._initialAnchor;
        }
        var anchorNoHash = anchor.indexOf('#') >= 0 ? anchor.slice(1) : anchor;
        var $anchor = anchorNoHash && jquery__WEBPACK_IMPORTED_MODULE_0___default()("#".concat(anchorNoHash));
        var $link = anchor && _this34.$element.find("[href$=\"".concat(anchor, "\"],[data-tabs-target=\"").concat(anchorNoHash, "\"]")).first();
        // Whether the anchor element that has been found is part of this element
        var isOwnAnchor = !!($anchor.length && $link.length);
        if (isOwnAnchor) {
          // If there is an anchor for the hash, select it
          if ($anchor && $anchor.length && $link && $link.length) {
            _this34.selectTab($anchor, true);
          }
          ...
          // Roll up a little to show the titles
          if (_this34.options.deepLinkSmudge) {
            var offset = _this34.$element.offset();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').animate({
              scrollTop: offset.top - _this34.options.deepLinkSmudgeOffset
            }, _this34.options.deepLinkSmudgeDelay);
          }
           ...
           * @event Tabs#deeplink
           */
          _this34.$element.trigger('deeplink.zf.tabs', [$link, $anchor]);
        }
      };
 ...
 * @requires foundation.util.triggers
 */
var Toggler = /*#__PURE__*/function (_Plugin19) {
  _inherits(Toggler, _Plugin19);
  var _super20 = _createSuper(Toggler);
  function Toggler() {
...
var Tooltip = /*#__PURE__*/function (_Positionable2) {
  ...
  var _super21 = _createSuper(Tooltip);
  function Tooltip() {
 ...
 */
var ResponsiveAccordionTabs = /*#__PURE__*/function (_Plugin20) {
  _inherits(ResponsiveAccordionTabs, _Plugin20);
  var _super22 = _createSuper(ResponsiveAccordionTabs);
  function ResponsiveAccordionTabs(element, options) {
    var _this35;
    _classCallCheck(this, ResponsiveAccordionTabs);
    _this35 = _super22.call(this, element, options);
    return _possibleConstructorReturn(_this35, _this35.options.reflow && _this35.storezfData || _assertThisInitialized(_this35));
  }
